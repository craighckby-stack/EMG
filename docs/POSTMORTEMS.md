...
**EVIDENCE (Machine-Copied Fact):**
```
Line 54, Col 8: Property declaration is missing its type annotation.
Line 71, Col 8: Property declaration is missing its type annotation.
```
...
```
Line 53, Col 8: Property declaration is missing its type annotation.
Line 70, Col 8: Property declaration is missing its type annotation.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on src/components/LogStream.tsx.
...
**EVIDENCE (Machine-Copied Fact):**
```
[LINT REJECT: NO_UNUSED_MACROS] Macro 'WP_ACTIVE' was defined but never applied in any function or type signature.
```
**CONSTRAINT (Model Generalization):** [STRUCK] Original constraint invalidated. Artifact of isolated compilation missing project context.
...
**EVIDENCE (Machine-Copied Fact):**
```
Line 129, Col 26: Unterminated string literal.
[OUTPUT_LIKELY_TRUNCATED] The output is < 80% of original length and syntactically invalid. The model likely hit its output token limit.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on src/utils/sanitizer.ts.
...
**EVIDENCE (Machine-Copied Fact):**
```
Line 147, Col 26: Unterminated string literal.
[OUTPUT_LIKELY_TRUNCATED] The output is < 80% of original length and syntactically invalid. The model likely hit its output token limit.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on src/utils/sanitizer.ts.
...
**EVIDENCE (Machine-Copied Fact):**
```
Line 136, Col 26: Unterminated string literal.
[OUTPUT_LIKELY_TRUNCATED] The output is < 80% of original length and syntactically invalid. The model likely hit its output token limit.
```
**CONSTRAINT (Model Generalization):** Never repeat code patterns that produce this compiler/linter error on src/utils/sanitizer.ts.
